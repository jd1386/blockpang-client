...
var _MyPage = _interopRequireDefault(require("./routes/MyPage"));
...
function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return React.createElement(_reactRouterDom.BrowserRouter, null, React.createElement(React.Fragment, null, React.createElement(_Navbar.default, null), React.createElement(_reactRouterDom.Route, {
        exact: true,
        path: "/",
