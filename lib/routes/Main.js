...
function (_Component) {
  ...
  _createClass(Home, [{
    key: "mainComponent",
    value: function () {
      var _mainComponent = _asyncToGenerator(
      /*#__PURE__*/
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", _react.default.createElement(_semanticUiReact.Container, null, _react.default.createElement(_semanticUiReact.Segment, {
                  style: {
                    padding: "8em 0em"
                  },
                  vertical: true
      ...
      return function mainComponent() {
        return _mainComponent.apply(this, arguments);
      };
    }()
  }, {
    key: "render",
